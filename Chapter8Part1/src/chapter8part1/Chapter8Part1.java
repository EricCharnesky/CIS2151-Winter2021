...
public class Chapter8Part1 {
    ...
    public static void main(String[] args) {
        ...
        Appointment CIS2151 = new Appointment(
                Appointment.DayOfWeek.THURSDAY, Appointment.TimeOfDay.MORNING, "CIS2151");

        mySchedule.addAppointment(CIS2151);
        
        var appointments = mySchedule.getAppointments();
        
        System.out.println(appointments.get(0) == CIS2151);
